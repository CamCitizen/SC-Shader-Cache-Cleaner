...
REM BFCPEEXE=C:\Users\CitizenBull\Desktop\SCSCC\SCSCC_1.0.8.exe
REM BFCPEICON=C:\Users\CitizenBull\Downloads\g34 (1).ico
...
REM BFCPEVERDESC=Simple Shader Cache Cleaner
REM BFCPEVERCOMPANY=CamCitizenMedia
